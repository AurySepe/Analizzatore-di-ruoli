...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  ...
  constructor() {
    ...
    pool.on('error', (err) => {
      // Evita che disconnessioni socket impreviste facciano crashare l'intero processo NestJS
  ...
  /**
   * Esegue una query Prisma gestendo automaticamente la riconnessione e il retry
   * in caso di disconnessioni socket o chiusura connessione da parte del server Postgres.
   */
  ...
  /**
   * Tenta la connessione al DB con retry automatico in caso di errore di avvio/connessione.
   */
