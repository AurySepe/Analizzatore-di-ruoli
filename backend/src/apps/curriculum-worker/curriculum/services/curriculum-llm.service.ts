...
- **Formula XYZ di Google**: Ogni bullet point nelle esperienze lavorative (summary) e nei progetti (description) MUST seguire la formula XYZ: "Accomplished [X] as measured by [Y], by doing [Z]".
...
- **Preservazione del Contesto Progetti**: Quando riformuli o adatti le descrizioni delle esperienze e dei progetti (es. MioCFO, LearningVerse, HapGree, MatEditPro, FitRats, BotanicAR, cARdefender), DEVI SEMPRE MANTENERE la frase/clausola introduttiva che chiarisce il contesto, la tipologia di prodotto e il dominio applicativo del progetto in modo che sia immediatamente chiaro a chiunque legga.
